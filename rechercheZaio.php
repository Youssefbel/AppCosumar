...
$sql1="SELECT * FROM Personnel WHERE numero LIKE '%$temp9%' AND site='ZAIO' ";
...
echo "</table>";
  ...
  var numero = '<?php echo $temp9 ?>';
      ...
      <button type="button" class="btn btn-lg" onclick="window.location.href = 'modifierZaio.php?num=' + numero">Modifier</button>
      <button type="button" class="btn btn-lg"  onclick="window.location.href = 'supprimerZaio.php?num=' + numero">Supprimer</button></div>
    </section>
