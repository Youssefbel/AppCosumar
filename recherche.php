...
$sql1="SELECT * FROM Personnel WHERE numero LIKE '%$temp9%' ";
...
echo "</table>";
  ...
  var numero = '<?php echo $temp9 ?>';
      ...
      <button type="button" class="btn btn-lg" onclick="window.location.href = 'modifier.php?num=' + numero">Modifier</button>
      <button type="button" class="btn btn-lg"  onclick="window.location.href = 'supprimer.php?num=' + numero">Supprimer</button></div>
    </section>
