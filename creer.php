...
<body>
  ...
  <section class="page-section">
    <div class="container">
      <form action="cr.php" method="POST" style="width: 50%;margin-left: 200px;color:white;font-style: italic">
              <div class="form-group">
               <label for="nom">Nom:</label>
               <input type="text" class="form-control" name="nom" autofocus required="required" >
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label for="droit">Droits d'accès:</label>
                <input type="text" class="form-control" name="droit" required="required" >
              </div>
              <div class="form-group">
