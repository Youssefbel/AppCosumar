...
<?php
$name = $_GET['name'];
  $sql5="SELECT * FROM fixe WHERE nom='".$name."' ";
...
?>
  ...
  <section class="page-section">
    <div class="container">
      <form action="fm.php" method="POST" style="width: 50%;margin-left: 200px;color:white;font-style: italic">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="poste" required="required" value="<?php echo $data5['poste']; ?>">
              </div>
