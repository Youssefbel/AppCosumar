...
$sql1="SELECT * FROM Personnel WHERE numero LIKE '%$temp9%' AND site='SUNABEL' ";
...
echo "</table>";
  ...
  var numero = '<?php echo $temp9 ?>';
      ...
      <button type="button" class="btn btn-lg" onclick="window.location.href = 'modifierSunabel.php?num=' + numero">Modifier</button>
      <button type="button" class="btn btn-lg"  onclick="window.location.href = 'supprimerSunabel.php?num=' + numero">Supprimer</button></div>
    </section>
