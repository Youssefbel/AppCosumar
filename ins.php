...
$sql="INSERT INTO personnel(nom,prenom,site,matricule,service,numero,statut,forfait,gsm,date,facture) 
VALUES('$temp1','$temp2','$temp3','$temp4','$temp5','$temp6','$temp7','$temp8','$temp9','$temp10','$temp11')";
