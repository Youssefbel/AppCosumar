...
<body>
  ...
  <section class="page-section">
    <div class="container">
      <form action="insSuta.php" method="POST" style="width: 50%;margin-left: 200px;color:white;font-style: italic">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="site" value="SUTA" required="required" >
              </div>
              <div class="form-group">
