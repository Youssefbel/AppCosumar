...
$temp9=$_POST['rech'];
$sql1="SELECT * FROM fixe WHERE nom LIKE '%$temp9%' ";
...
echo "</table>";
  ...
  var nm= '<?php echo $temp9 ?>';
      ...
      <button type="button" class="btn btn-lg" onclick="window.location.href = 'fmod.php?name=' + nm">Modifier</button>
      <button type="button" class="btn btn-lg"  onclick="window.location.href = 'fsup.php?name=' + nm">Supprimer</button></div>
    </section>
